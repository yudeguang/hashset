...
func NewUint16(values ...uint16) *SetUint16 {
	set := &SetUint16{Items: make(map[uint16]struct{}, len(values))}
	if len(values) > 0 {
		set.Add(values...)
	}
	return set
...
func (set *SetUint16) Clear() {
	set.Items = make(map[uint16]struct{})
}

// 转换成切片
func (set *SetUint16) ToSlice() []uint16 {
	values := make([]uint16, set.Size())
	count := 0
...
func UnionUint16(m, n *SetUint16) *SetUint16 {
	resultSet := &SetUint16{Items: make(map[uint16]struct{}, m.Size()+n.Size())}
...
func InnerJoinUint16(m, n *SetUint16) *SetUint16 {
	if m.Size() > n.Size() {
		//最大也只能是n
		resultSet := &SetUint16{Items: make(map[uint16]struct{}, n.Size())}
		for item := range n.Items {
